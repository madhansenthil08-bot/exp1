...
![WhatsApp Image 2025-11-28 at 21 17 13_1aa61dca](https://github.com/user-attachments/assets/349bd638-194b-4d31-bab2-c09a2ba1d0c8)


Calculation

```
ma (Theory) = am/ac = 6.6/13.2 = 0.5
ma(Practical) = (Emax-Emin)/(Emax+Emin) =12.8/26.8 = 0.5
```
